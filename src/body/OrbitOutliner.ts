...
//         this.workerExecutorPool = new ExecutorPool(Array.from({length: 8}).map(() => {
...
//         const sun = bodyObjects.find(o => o.body.name == "Sun")!;
//         bodyObjects.forEach(o => o.body.velocity.sub(sun.body.velocity));
